            ...
            <li>
              ...
              <div id="dropdownNavbar2" class="z-10 hidden  bg-neutral-900 rounded-md shadow-lg w-44">
                  <ul class="p-2 text-sm text-body font-medium" aria-labelledby="dropdownNvbarButton">
                    ...
                    <li>
                      <a href="https://alexandreferreira.dev/resources/AlexandreFerreiraCV.pdf" target="_blank" rel="noopener noreferrer"class="inline-flex items-center justify-center w-full p-2 text-white hover:bg-neutral-800 rounded">CV</a>
                    </li>
                  </ul>
              </div>
            </li>
